...
const itens = [
  { to: '/dashboard', label: 'Dashboard', icon: '📊', fim: true },
  { to: '/crm', label: 'CRM', icon: '📋' },
  { to: '/clientes', label: 'Clientes', icon: '👥' },
  { to: '/vendedores', label: 'Vendedores', icon: '🏷️' },
  { to: '/metas', label: 'Metas & Comissões', icon: '🎯' },
  { to: '/links', label: 'Links dos vendedores', icon: '🔗' },
  { to: '/importar', label: 'Importar / Sincronização', icon: '☁️' },
];
